...
(defvar editor-packages
  '(ace-jump-mode anzu auto-complete browse-kill-ring coffee-mode dedicated diminish dropdown-list expand-region flycheck
                  golden-ratio git-gutter git-timemachine go-autocomplete go-mode helm helm-projectile highlight-indentation
