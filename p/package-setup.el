...
(defvar editor-packages
  '(avy ace-window ag aggressive-indent anaconda-mode anzu company company-go company-anaconda company-lsp company-quickhelp
        dedicated diminish emmet-mode expand-region exec-path-from-shell flycheck flycheck-color-mode-line git-gutter
        git-link git-timemachine github-browse-file go-eldoc go-mode go-guru go-fill-struct graphql-mode helm
        ...
        react-snippets scss-mode smartparens use-package web-mode window-numbering yaml-mode yapfify yasnippet)
